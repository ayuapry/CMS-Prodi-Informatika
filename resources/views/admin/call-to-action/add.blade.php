...
@section('title', 'Tambah Data Call To Action')

@section('content')
    <div class="pagetitle">
        <h1>Tambah Data Call To Action</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="/admin/call-to-action">Call To Action</a></li>
                <li class="breadcrumb-item active">Tambah Data Call To Action</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah Data Call To Action</h5>

                        <!-- General Form Elements -->
                        <form action="/admin/call-to-action" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
