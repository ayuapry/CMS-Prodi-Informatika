...
@section('title', 'Tambah Data Organization')

@section('content')
    <div class="pagetitle">
        <h1>Tambah Data Organization</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="/admin/organization">Organization</a></li>
                <li class="breadcrumb-item active">Tambah Data Organization</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah Data Organization</h5>
