...
@section('content')
    <div class="pagetitle">
        <h1>Tambah Data About Us</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="/admin/about-us">About Us</a></li>
                <li class="breadcrumb-item active">Tambah Data About Us</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah Data About Us</h5>
                        ...
                        <form action="/admin/about-us" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                @error('description')
                                    <div class="invalid-feedback">
                                        Deskripsi Pandang tidak boleh kosong
                                    </div>
                                @enderror
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" id="selayang" class="form-control @error('selayang') is-invalid @enderror"
                                        name="selayang"></textarea>
                                </div>
                                @error('selayang')
                                    <div class="invalid-feedback">
